...
game.map([[brick] * 3], column=2, row=23, solid=True)
game.text("HENLO MAI GUD FRENZ", column=6, row=2)
...
jump_sound = Tone(660, frames=14, volume=8)
...
if __name__ == "__main__":
    result = game.build(Path(__file__).resolve().parents[1] / "build" / "keys_and_platforms2.nes")
